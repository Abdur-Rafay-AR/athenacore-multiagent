...
from athenacore.agents.registry import available_agents, describe_agents
from athenacore.config import Settings
from athenacore.errors import AthenaCoreError
from athenacore.llm.registry import available_providers
...
from athenacore.ui import theme
...
def render_sidebar(settings: Settings) -> tuple[str, str]:
    ...
    st.sidebar.markdown("## 🏛️ AthenaCore")
    ...
    with st.sidebar.expander("Advanced", expanded=False):
        ...
        st.checkbox(
            ...
            key="web_search",
            help="Requires: pip install 'athenacore[search]'",
        )
