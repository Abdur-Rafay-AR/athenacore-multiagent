...
Executes an :class:`~crucible.orchestration.graph.AgentGraph` against a topic:
...
from crucible.agents.base import AgentContext, AgentResult
from crucible.agents.registry import AgentFactory
from crucible.config import Settings
from crucible.errors import CrucibleError, RunCancelled
from crucible.llm.base import LLMProvider, Message
...
from crucible.memory.embeddings import Embedder, HashingEmbedder
from crucible.memory.models import Entry, EntryKind, Run, RunStatus, Usage, utcnow
...
from crucible.orchestration.graph import AgentGraph
from crucible.tools.base import ToolRegistry
from crucible.tools.builtin import default_registry
...
class RunReport:
    ...
    def transcript(self) -> str:
        from crucible.agents.base import format_transcript
...
class Orchestrator:
    ...
    def _execute_levels(
        ...
        with ThreadPoolExecutor(max_workers=workers, thread_name_prefix="crucible") as pool:
