...
from crucible.memory.embeddings import Embedder, cosine, similarity_to_unit
from crucible.memory.models import Entry, EntryKind, estimate_tokens, utcnow
from crucible.memory.store import EntryFilter, MemoryStore, ScoredEntry
...
class MemoryRetriever:
    ...
    def index_pending(self, *, topic: str | None = None, batch: int = 200) -> int:
        ...
        Called after writes and by ``crucible reindex``; keeping it incremental
